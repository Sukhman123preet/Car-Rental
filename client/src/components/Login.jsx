            ...
            <form  onSubmit={onSubmitHandler} onClick={(e)=>e.stopPropagation()} className="fixed z-[101] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col gap-4 m-auto items-start p-8 py-12 w-80 sm:w-[352px] rounded-lg shadow-xl border border-gray-200 bg-white ">
                ...
                {state === "register" ? (
                    <p>
                        ...
                        <span onClick={() => setState("login")} className="text-blue-600  cursor-pointer">click here</span>
                    </p>
                ) : (
                    <p>
                        Create an account?{" "}
                        <span onClick={() => setState("register")} className="text-blue-600 cursor-pointer">click here</span>
                    </p>
                )}
                <button className="bg-blue-600 hover:bg-blue-800 transition-all text-white w-full py-2 rounded-md cursor-pointer">
