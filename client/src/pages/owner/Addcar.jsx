...
const Addcar = () => {
  ...
  return (
    <div className='px-4pt-10 md:px-10 flex-1'>
      <Title title="Add new Car" subTitle="Fill in detials to list a new car for booking, including pricing, availability, and car specifications." />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col w-full">
            ...
            <input type="text" placeholder="e.g. X5, E-class, M4..." required
              className="px-3 py-2 mt-1 border border-borderColor rounded-md outline-none"
              value={car.model} onChange={(e) => setCar({ ...car, [brand]: e.target.value })} />
          </div>
        </div>
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
        ...
        <div className='flex flex-col w-full'>
          ...
          <input type="number" placeholder="e.g. 2020, 2021..." required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none ' value={car.year} onChange={(e) => setCar({ ...car, year: e.target.value })} />
        </div>
        <div className='flex flex-col w-full'>
          <label className='flex flex-col'>
...
<div className='flex flex-col w-full'>
  <label >Description
    ...
    <textarea placeholder='Write a brief description of your car, including features, condition, and any special notes.' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none ' value={car.description} onChange={(e) => setCar({ ...car, description: e.target.value })} />
</div>
