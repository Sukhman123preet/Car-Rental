...
export const addCar = async (req, res) => {
  try {
    ...
    console.log("Parsed carData:", car);
...
res.json({success:true,message:"Image updated" , img_link:image})


  }
  catch(error){
    console.log(error.message);
    rea.json({success:false,message:error.message})
  }
}